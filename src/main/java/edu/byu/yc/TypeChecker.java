...
public class TypeChecker {
     ...
     * @return A sequence of paths to Java files, either from paths or contained
     *         in a directory specified by paths.
     */
    ...
    /**
     * Parse all of the Java files in paths and return the concatenation of
     * their contents.
     * 
    ...
    /**
     * Get the names of every identifier whose letters are all capitalized in
     * node.
     * 
    ...
    public static void main(String[] args) {
        ...
        node.accept(v);
        Set<CFG> cfgs = v.getCFGs();
        for (CFG cfg : cfgs) {
            final String cfgString = cfg.toString();
            ...
            Map<Node, Set<String>> result = lv.analyze();
            String resultString = cfg
                    .buildOverOrderedKeys((List<Node> keys) -> {
